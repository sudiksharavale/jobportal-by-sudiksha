...
function insertJobs(){ 
    ...
    fetch('/jobportal/src/php/jobOut.php',{
        method: 'POST'
...
let emailSubscriptionBody = "You've successfully signed up for jobportal's email subscription!";
function subscribeEmail(){
    ...
    if(userEmail != ""){
        ...
        window.open("mailto:" + userEmail + "?subject=jobportal.com&body=" + emailSubscriptionBody);
    }
}
